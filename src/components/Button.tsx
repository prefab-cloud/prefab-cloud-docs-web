...
const Button = ({ label, href, type = "primary" }) => {
  if (type === "secondary") {
    return (
      ...
      >
        <div className="text-md md:text-xl font-medium leading-tight tracking-wide font-['Barlow']">
          {label}
        </div>
      </a>
    );
  ...
  return (
    ...
    >
      <div className="text-white text-md md:text-xl font-medium leading-tight tracking-wide font-['Barlow']">
        {label}
      </div>
    </a>
  );
